...
import de.pareus.hiptest.config.audit.AuditEventConverter;
import de.pareus.hiptest.domain.PersistentAuditEvent;
...
import static de.pareus.hiptest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
