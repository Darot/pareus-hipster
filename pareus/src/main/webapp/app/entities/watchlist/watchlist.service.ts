...
export class WatchlistService {
    ...
    private resourceUrl =  SERVER_API_URL + 'api/watchlists';
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/watchlists';

    constructor(private http: Http) { }

    create(watchlist: Watchlist): Observable<Watchlist> {
        const copy = this.convert(watchlist);
    ...
    update(watchlist: Watchlist): Observable<Watchlist> {
        const copy = this.convert(watchlist);
    ...
    find(id: number): Observable<Watchlist> {
